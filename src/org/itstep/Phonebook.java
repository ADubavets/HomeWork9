...
Контакт может включать в себя:
    ...
    ■ фамилия;
    ■ прозвище;
    ■ номера телефонов (неограниченное количество, может быть несколько с одинаковым типом). Номера телефонов
...
public class Phonebook {
    ...
    private static void savePB() throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("src/org/itstep/Data/phone.txt"));
    ...
    public static void loadPB() throws IOException {
        ...
        if (file.exists()) {
            BufferedReader reader = new BufferedReader(new FileReader("src/org/itstep/Data/phone.txt"));
            String act;
